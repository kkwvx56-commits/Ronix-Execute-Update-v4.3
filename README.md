...
[![Stars](https://img.shields.io/github/stars/Ronix-Execute-Update-v4.3?style=flat-square)](https://github.com)
...
git clone https://github.com/Ronix-Execute-Update-v4.3.git
cd Ronix-Execute-Update-v4.3
